// Scanner.js - MTG Scanner Pro with PayPal Integration (200 cards/$19.99)
...
const Scanner = () => {
    ...
    // 🔥 UPDATED: Collection limits and premium features (200 cards, $19.99)
    const [isPremiumUser, setIsPremiumUser] = useState(false);
    const [showPaywallModal, setShowPaywallModal] = useState(false);
    const FREE_COLLECTION_LIMIT = 200; // 🔥 INCREASED FROM 100 TO 200
    ...
    // Scanning functions (keeping existing logic)
    const startScanning = () => {
    ...
    const saveCardToCollection = async (card) => {
        try {
            // 🔥 UPDATED: Check new 200 card limit
            if (!isPremiumUser && savedCards.length >= FREE_COLLECTION_LIMIT) {
                console.log('🚨 Free collection limit reached (200 cards)');
    ...
    // 🔥 UPDATED: PayPal integration with new price ($19.99)
    const handleUpgradeToPremium = () => {
        console.log('💎 Initiating PayPal payment for premium upgrade ($19.99)...');
        
        // 🔥 UPDATED: PayPal link with new price and email
        ...
        <div className="mtg-scanner-pro" style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                    ...
                    <div>
                        ...
                        <span style={{ fontSize: '0.9rem', color: '#b0bec5' }}>
                            🔥 Professional Grade • 200 Free Cards • $19.99 Premium
                        </span>
                    </div>
                </div>
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', gap: '16px', alignItems: 'center', flexWrap: 'wrap' }}>
                    ...
                    <span style={{ fontSize: '14px' }}>
                        📁 Collection: {savedCards.length}/{FREE_COLLECTION_LIMIT}
                    </span>
                    <span style={{ fontSize: '14px' }}>
            ...
            {/* 🔥 UPDATED: Premium Upgrade Modal (200 cards, $19.99) */}
            {showPaywallModal && (
                <div style={{
                    position: 'fixed',
                    top: 0,
                    ...
                    <div style={{
                        ...
                        <div style={{ margin: '20px 0', fontSize: '18px' }}>
                            ...
                            <p style={{ margin: '8px 0', lineHeight: '1.5', color: '#4a90e2' }}>
                                <strong>200 cards is a substantial collection!</strong> 
                            </p>
                        </div>
                        ...
                        <div style={{
                            ...
                            <ul style={{ textAlign: 'left', lineHeight: '1.8', margin: 0, paddingLeft: '20px' }}>
                                ...
                                <li>📈 <strong>Investment portfolio tracking</strong></li>
                                <li>⚡ <strong>Priority customer support</strong></li>
                                <li>🔄 <strong>Cloud backup & sync</strong></li>
                                <li>📤 <strong>Advanced export options</strong></li>
                            </ul>
                        </div>
                        ...
                        <div style={{
                            ...
                            <p>🔒 One-time payment • No subscription • Lifetime premium access</p>
                            <p>💯 <strong>200 free cards is generous - Premium unlocks unlimited potential!</strong></p>
                        </div>
                    </div>
                </div>
            )}
            ...
            {showContinueDialog && (
                <div style={{
                    ...
                    <div style={{
                        ...
                        <p style={{ margin: '8px 0', lineHeight: '1.5' }}>
                            Total saved to collection: <strong>{savedCards.length}/{FREE_COLLECTION_LIMIT}</strong> cards
                        </p>
